// 工具条图标取自 Lucide (https://lucide.dev)，ISC 许可证；由 scripts/generate-icons.mjs 生成，请勿手改。
// 使用图标：mouse-pointer-2, square, rectangle-horizontal, move-up-right, pen-line, highlighter, grid-2x2, type, eraser, undo-2, redo-2, x, pin, save, copy, trash-2, download, chevron-down, chevron-up, upload, history, settings, arrow-left-right, clipboard-copy, refresh-cw, languages, check
...
export const ICON_PATHS = {
  ...
  line: '<path d="M13 5H19V11" /><path d="M19 5L5 19" />',
  ...
  mosaic: '<path d="M12 3v18" /><path d="M3 12h18" /><rect x="3" y="3" width="18" height="18" rx="2" />',
